                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-gray-50 rounded-lg p-4">
                      ...
                      <p className="text-2xl font-bold text-gray-900">{convertHeight(pokemon.height).toFixed(1)} m</p>
                    </div>
                    <div className="bg-gray-50 rounded-lg p-4">
                      <h4 className="font-semibold text-gray-700">Weight</h4>
                      <p className="text-2xl font-bold text-gray-900">{convertWeight(pokemon.weight).toFixed(1)} kg</p>
                    </div>
                  </div>
                </div>
              </div>
